MASTER PROMPT V12 — MAURITIUS MORNING NEWSLETTER
...
Do not include inline source URLs in the newsletter text. Instead,
collect all sources into a SOURCES appendix at the end of the output
(see Section 7, SOURCES APPENDIX). The editor will add hyperlinks
manually in the publishing tool.
...
Follow this structure exactly. Output plain text only.
...
- Plain text output only. No inline URLs in newsletter body.
...
[ ] No inline URLs in newsletter body
